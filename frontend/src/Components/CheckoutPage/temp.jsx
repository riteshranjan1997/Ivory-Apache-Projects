...
//               <div style={{marginTop:"85px",fontWeight:"500"}} ><b><p style={{fontWeight:"bold",fontSize:15.4}}>Your order from</p></b></div>
//               <div><p style={{fontSize:14}}>{cart[0].restaurant_name=== " " ? " " : cart[0].restaurant_name  }</p></div>
//               <hr/>
//               {cart && cart.map((item)=>(
//                 <div>
...
//                 <div><b>Rupees</b></div>
//               </div>
//               <div style={{background:"#2B8282",padding:"20px",color:"white",fontSize:"20px",marginTop:"220px",position:"absolute",zIndex:150}}><span>{">"}</span>Modify Your Order</div>
//               <div className="d-flex  justify-content-between bg-secondary text-white p-2 " >
//                 <div><b>Total</b></div>
//                 <div><b>{cart && cart.reduce((a,item)=>(
//                                   a+item.price
//                     ),0)}Rupees</b>
                
//               </div>
//               </div>
//         <div style={{width:"100%",color:"blue",height:"10px",position:"absolute",border:"1px solid red",width:"478px",height:"32px",right:0,bottom:0,zIndex:100}}>back</div>
//         </div>
//        </div>
//   </CheckoutPageWrapper>
//   </div>
