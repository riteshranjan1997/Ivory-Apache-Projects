      ...
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <Typography variant="body2" color="textSecondary" component="p">
            ...
            yourself. Just simple neighborhood food delivery. Seamless is a part
            of the Grubhub Inc. portfolio of brands. For more information on
            Grubhub, Inc., please visit about.grubhub.com.
          </Typography>
        </Typography>
      </Grid>
      <Grid item xs={12} md={6}>
