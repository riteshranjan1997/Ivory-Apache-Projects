                    ...
                    <CardContent>
                        <Typography className={classes.title}>
                           <div className={classes.upcomingOrders} >
                               <div style={{marginRight:"20px"}}><img src="https://www.seamless.com/assets/img/no-results.svg" height="100px" alt="upcomingorders"/></div>
                               <div>
                                   <div><h2>Your upcoming orders </h2></div>
                                   <div><p className="text-muted">Plan out your food for Today and later in the week</p></div>
                                   <Button
                                    style={{
                               ...
                               <Card className={classes.date}>
                                    <CardContent>                                       
                                            ...
                                            <div className={classes.dateCard}>
                                                <div className={classes.insideDateCard}>Today</div>
                                                <div className={classes.insideDateCard} ><h3 className="text-muted"><b>{dateItem[2]}</b></h3></div>
                                                <div
                                                    style={{
                                                        color: "#2B8282",
                                                        width: "100px",
                                            ...
                                            <div className={classes.dateCard}>
                                                {getDate(i)}
                                               <div className={classes.insideDateCard}>{dateItem[0]}</div>
                                               <div className={classes.insideDateCard}><h3 className="text-muted"><b>{dateItem[2]}</b></h3></div>
                                               <div
                                                    style={{
                                                        color: "#2B8282",
