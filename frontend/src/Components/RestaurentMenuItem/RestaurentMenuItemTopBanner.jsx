...
function RestaurentMenuItemTopBanner() {
  console.log("in restaurant banner");
  ...
  return (
    <div>
      <BannerWrapper>
        ...
        <img
          className="img-fluid"
          src={`../${item.restaurant_images}`}
          style={{ marginTop: "65px", objectFit: "cover", zIndex: "2" }}
          alt="ImageBanner"
        />
        <BackArrow>
          <Link to="/search">
        ...
        >
          ...
          <DialogContent>
            ...
            <DialogContentText>
              ...
              <div className={classes.icons}>
                <i class="fas fa-bolt"></i> Copy Link
              </div>
            </DialogContentText>
          </DialogContent>
        </Dialog>
